...
class Cart extends Component {
    ...
    componentDidMount() {
        ...
        console.log("didmount", this.props.cartList.isPending);
        navigation.addListener("didFocus", () => {
            this.props.fecthCartList();
            console.log("didfocus ispending", this.props.cartList.isPending);
        });

        navigation.addListener("didBlur", () => {
            this.props.updateCart(this.props.cartList.cartList);
            console.log("didblur ispending", this.props.cartList.isPending);
        });
    }
    ...
    deleteItem = () => {
        ...
        this.props.deleteCartItem(this.state.temporaryId);
        this.setState({
            isModalVisible: !this.state.isModalVisible
        });
    };
    ...
    render() {
        console.log("render isPending", this.props.cartList.isPending);

        return (
            <Container>
                {this.props.cartList.isPending && (
                ...
                >
                    ...
                    >
                        <Text style={{ fontWeight: "bold" }}>
                            Do You Want To Delete {this.state.deleteItem} From
                            Cart ?
                        </Text>
                        <View
                            style={{
                        ...
                        >
                            <Button transparent dark onPress={this.deleteItem}>
                                <Text>Yes</Text>
                            </Button>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        deleteCartItem: id => dispatch(deleteCartItems(id))
    };
};
